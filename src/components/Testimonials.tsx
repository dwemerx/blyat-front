      ...
      <div className='relative w-screen h-64'>
        <div className='relative w-screen'>
          ...
          <div className='relative flex items-center justify-between w-screen px-8 my-auto h-600px xl:px-16'>
            <button
              className='w-16 h-16 bg-white rounded-full outline-none xl:w-24 xl:h-24 grid place-items-center xl:p-6 focus:outline-none hover:scale-110 active:translate-y-4 transform duration-500 easy-out shadow-card'
              onClick={() => moveLeft()}
            >
              <ChevronLeft size={32} />
            </button>
